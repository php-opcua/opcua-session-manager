...
describe('Write via ManagedClient', function () {
    ...
    describe('Write and read back scalars', function () {
        ...
        it('writes a string to StringValue and reads it back', function () {
            ...
            try {
                ...
                $testString = 'SessionManager test ' . time();
    ...
    describe('WriteMulti', function () {

        it('writes multiple values in one call', function () {
            $client = null;
            try {
                $client = TestHelper::connectNoSecurity();
    ...
    describe('Array writes', function () {
    ...
    describe('Write to read-only variables', function () {
        ...
        it('fails to write to Boolean_RO', function () {
            $client = null;
            try {
                $client = TestHelper::connectNoSecurity();
